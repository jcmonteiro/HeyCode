...
const createMockTranscriber = (overrides: Partial<TranscriberPort> = {}): TranscriberPort => ({
...
describe("startAndWaitRecording", () => {
  ...
  it("starts recording and waits for auto-stop", async () => {
    ...
    const result = await startAndWaitRecording({ recorder: recorder as any, transcriber })
  ...
  it("throws if already recording", async () => {
    ...
    await expect(startAndWaitRecording({ recorder: recorder as any, transcriber }))
  ...
  it("calls onStarted callback when recording begins", async () => {
    ...
    await startAndWaitRecording({ recorder: recorder as any, transcriber, onStarted })
  ...
  it("calls onStopped callback when recording auto-stops", async () => {
    ...
    await startAndWaitRecording({ recorder: recorder as any, transcriber, onStopped })
